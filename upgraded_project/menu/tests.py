...
class ViewsTest(TestCase):
    def setUp(self):
        ...
        # create ingredients of an item to test
    ...
    def test_menu_detail_view(self):
        response = self.client.get(reverse('menu_detail',
    ...
    def test_menu_item_view(self):
        response = self.client.get(reverse('item_detail',
                                       kwargs={'pk': self.menu1.item1.pk}))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response,
